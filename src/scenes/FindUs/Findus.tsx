        ...
        <div className="w-full lg:w-1/3 flex flex-col lg:items-start my-5 space-y-6">
            ...
            <div className="mt-4 text-gray-100 space-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-[#5d0000] font-bold text-lg">
                    <a href="tel:070056 42234">070056 42234</a>
                  </p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-lg font-bold text-[#5d0000]">Infinity Fitness  Gym</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-lg font-bold text-[#5d0000]">
                    <a href="mailto:amitroy.08091986@gmail.com">amitroy.08091986@gmail.com</a>
                  </p>
              ...
              <div className="flex space-x-4 mt-4 text-gray-500 text-2xl">
                <a href="https://www.instagram.com/explore/locations/109450265377052/infinity-fitness-gym/" className="hover:text-yellow-500"><FaInstagram /></a>
                <a href="https://www.facebook.com/infinityfitnessagt/" className="hover:text-[#2f2484]"><FaFacebook /></a>
