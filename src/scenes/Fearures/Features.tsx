    ...
    <section className="w-full text-white mx-auto pt-20 mt-12">
      ...
      <div className="w-full bg-gray-100 flex flex-col items-center py-12 px-6">
        ...
        <p className="text-lg mt-12 text-gray-900 text-center max-w-4xl">
          Thank you for exploring Infinity Fitness  Fitness Gym, where your fitness journey transforms into a lifestyle of health and vitality. Join our community today and take advantage of our special discount for the first 30 members. Because here at Infinity Fitness , every workout is a step towards your best self. Stay fit, stay healthy, and keep making big deals out of your fitness goals!
        </p>
      </div>
    </section>
  );
